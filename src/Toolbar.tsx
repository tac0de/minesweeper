...
const ListItem = (props: {
  ...
  <li>
    <label htmlFor={props.value}>
      ...
      />
      {levels[props.value] === levels.BEAST
        ? `${titleCase(props.value)} Mode`
  ...
  <div className="toolbar">
    ...
    <div
      className={classNames("modal", {
        visible: props.modal === modals.OPTIONS
      })}
    ...
    <div
      className={classNames("modal", { visible: props.modal === modals.ABOUT })}
      style={{ left: props.left }}
    >
